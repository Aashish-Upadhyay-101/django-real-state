...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="NP", blank_label="(select country)")
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Hetauda")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=20, default="41107")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="ABC Road")
    ...
    tax = models.DecimalField(verbose_name=_("Tax"), max_digits=6, decimal_places=2, default=0.13, help_text="13% property tax charged")
    ...
    cover_photo = models.ImageField(verbose_name=_("Cover Photo"), default="/house_default.jpg", null=True, blank=True)
    ...
    def final_property_price(self):
        tax_amount = round(self.tax * self.price, 2)
        price_after_tax = float(round(self.price + tax_amount, 2))
        return price_after_tax


class PropertyViews(TimeStampedUUIDModel):
    ip = models.CharField(verbose_name=_("IP Address"), max_length=100)
    property = models.ForeignKey(Property, related_name="property_views", on_delete=models.CASCADE, null=True)
